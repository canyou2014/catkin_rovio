...
if(NOT "include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3 " STREQUAL " ")
  set(lightweight_filtering_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lyw/catkin_rovio/install/${idir}'.  Ask the maintainer 'Michael Bloesch <bloeschm@ethz.ch>' to fix it.")
    endif()
