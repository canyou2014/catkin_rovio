...
if("TRUE" STREQUAL "TRUE")
  set(lightweight_filtering_SOURCE_PREFIX /home/lyw/catkin_rovio/src/rovio/lightweight_filtering)
  set(lightweight_filtering_DEVEL_PREFIX /home/lyw/catkin_rovio/devel/.private/rovio)
  ...
  set(lightweight_filtering_INSTALL_PREFIX /home/lyw/catkin_rovio/install)
...
if(NOT "/home/lyw/catkin_rovio/src/rovio/lightweight_filtering/include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3 " STREQUAL " ")
  set(lightweight_filtering_INCLUDE_DIRS "")
  set(_include_dirs "/home/lyw/catkin_rovio/src/rovio/lightweight_filtering/include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Bloesch <bloeschm@ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lyw/catkin_rovio/src/rovio/lightweight_filtering/${idir}'.  Ask the maintainer 'Michael Bloesch <bloeschm@ethz.ch>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lightweight_filtering_dep}_FOUND)
      find_package(${lightweight_filtering_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lightweight_filtering_dep} REQUIRED ${depend_list})
  endif()
