...
if("TRUE" STREQUAL "TRUE")
  set(rovio_SOURCE_PREFIX /home/lyw/catkin_rovio/src/rovio)
  set(rovio_DEVEL_PREFIX /home/lyw/catkin_rovio/devel/.private/rovio)
  set(rovio_INSTALL_PREFIX "")
  set(rovio_PREFIX ${rovio_DEVEL_PREFIX})
else()
  set(rovio_SOURCE_PREFIX "")
  set(rovio_DEVEL_PREFIX "")
  set(rovio_INSTALL_PREFIX /home/lyw/catkin_rovio/install)
...
if(NOT "/home/lyw/catkin_rovio/devel/.private/rovio/include;/home/lyw/catkin_rovio/src/rovio/include;/home/lyw/catkin_rovio/src/rovio/lightweight_filtering/include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(rovio_INCLUDE_DIRS "")
  set(_include_dirs "/home/lyw/catkin_rovio/devel/.private/rovio/include;/home/lyw/catkin_rovio/src/rovio/include;/home/lyw/catkin_rovio/src/rovio/lightweight_filtering/include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/local/include/eigen3;/usr/include;/usr/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rovio' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bloeschm <bloeschm@ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rovio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lyw/catkin_rovio/src/rovio/${idir}'.  Ask the maintainer 'bloeschm <bloeschm@ethz.ch>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lyw/catkin_rovio/devel/.private/rovio/lib;/home/lyw/catkin_rovio/devel/lib;/opt/ros/indigo/lib)
...
set(rovio_EXPORTED_TARGETS "rovio_generate_messages_cpp;rovio_generate_messages_lisp;rovio_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rovio_dep}_FOUND)
      find_package(${rovio_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rovio_dep} REQUIRED ${depend_list})
  endif()
